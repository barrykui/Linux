...
Destination_Folder="/data/jack/kitti2012fast/"
num_1_last=""
num_2_last=""
...
#	break
	...
	./main.lua kitti fast -a predict -net_fname net/net_kitti_fast_-a_train_all.t7 -left ${Folder_A}${num_1}_${num_2}_BACK_LEFT.png -right ${Folder_B}${num_1}_${num_2}_FRONT_RIGHT.png -disp_max 70
	...
	./main.lua kitti fast -a predict -net_fname net/net_kitti_fast_-a_train_all.t7 -left ${Folder_A}${num_1}_${num_2}_FRONT_LEFT.png -right ${Folder_B}${num_1}_${num_2}_BACK_RIGHT.png -disp_max 70
	luajit samples/bin2png.lua 
	...
	./main.lua kitti fast -a predict -net_fname net/net_kitti_fast_-a_train_all.t7 -left ${Folder_A}${num_1}_${num_2}_LEFT_LEFT.png -right ${Folder_B}${num_1}_${num_2}_RIGHT_RIGHT.png -disp_max 70
	luajit samples/bin2png.lua 
	...
	./main.lua kitti fast -a predict -net_fname net/net_kitti_fast_-a_train_all.t7 -left ${Folder_A}${num_1}_${num_2}_RIGHT_LEFT.png -right ${Folder_B}${num_1}_${num_2}_LEFT_RIGHT.png -disp_max 70
	luajit samples/bin2png.lua 
